...
public class PatrimoineRicheMoyenCas implements Supplier<Patrimoine> {
  ...
  private Set<Possession> possessionsCresus(Argent bp, Argent a2, Dette dette, Creance creance) {
    ...
    new FluxArgent(
        "Raly remb. Myriade", a2, debutRembMyriade, debutRembMyriade.plusYears(3), 500, 25);
    new FluxArgent(
        "Rom remb. Myriade 1/2", a2, debutRembMyriade, debutRembMyriade.plusYears(1), 1050, 25);
    new FluxArgent(
    ...
    new FluxArgent(
        ...
        ajd,
        ajd,
        500 * (int) LocalDate.of(2023, SEPTEMBER, 1).until(ajd, MONTHS),
        ajd.getDayOfMonth());
        ...
        new GroupePossession(
            ...
            Set.of(
                ...
                new FluxArgent(
                    ...
                    dateRembZanzEtCie.getDayOfMonth()),
                new FluxArgent(
                    "Honoraires Villey Byzance", dette, ajd, ajd, -15_000, ajd.getDayOfMonth()),
                new FluxArgent(
    ...
    return Set.of(bp, a2, dette, creance, byzance);
  }

  private Set<Possession> possessionsMyriade(
      Argent myriadeFr, Creance creanceFr, Dette detteMyriadeFr, Argent myriadeMg, Argent bp) {
    // note(verif)
    var dateRembCAR = LocalDate.of(2024, JULY, 10);
    new FluxArgent(
        "CAR remb.", myriadeFr, dateRembCAR, dateRembCAR, 78_000, dateRembCAR.getDayOfMonth());
    var dateRembCCA = LocalDate.of(2024, JULY, 15);
    new TransfertArgent(
        "CCA remb.", myriadeFr, bp, dateRembCCA, dateRembCCA, 30_000, dateRembCCA.getDayOfMonth());
    ...
    new FluxArgent(
        ...
        ajd,
        ajd,
        -3_700 * (int) LocalDate.of(2024, MARCH, 1).until(ajd, MONTHS),
        ajd.getDayOfMonth());
